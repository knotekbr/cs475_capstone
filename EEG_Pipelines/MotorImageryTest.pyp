...
<scheme description="This pipeline predicts imagined motor actions using neural oscillatory pattern classification. The main node of this pipeline is the Common Spatial Pattern (CSP) filter, which is used to retrieve the components or patterns in the signal that are most suitable to represent desired categories or classes. CSP and its various extensions (available through NeuroPype) provide a powerful tool for building applications based on neural oscillations.&#10;This pipeline can be divided into 4 main parts, which we discuss in the following:&#10;&#10;Data acquisition:&#10;Includes : Import Data (here titled “Import SET”), LSL input/output, Stream Data and Inject Calibration Data nodes.&#10;In general you can process your data online or offline. For developing and testing purposes you will be mostly performing offline process using a pre-recorded file.&#10;&#10;- The “Import Data” nodes (here titled “Import Set”) are used to connect the pipeline to files.&#10;&#10;- The “LSL input” and “LSL output” nodes are used to get data stream into the pipeline, or send the data out to the network from the pipeline. (If you are sending markers make sure to check the “send marker” option in “LSL output” node)&#10;&#10;- The “Inject Calibration Data” node is used to pass the initial calibration data into the pipeline before the actual data is processed. The calibration data (Calib Data) is used by adaptive and machine learning algorithms to train and set their parameters initially. The main data is connected to the “Streaming Data” port.&#10;&#10;NOTE regarding “Inject Calibration Data”: &#10;In case you would like to train and test your pipeline using files (without using streaming node), you need to set the “Delay streaming packets” in this node. This enables the “Inject Calibration Data” node to buffer the test data that is pushed into it for one cycle and transfer it to the output port in the next cycle. It should be noted that the first cycle is used to push the calibration data through the pipeline.&#10;&#10;Data preprocess:&#10;Includes: Assign Targets, Select Range,  FIR filter and Segmentation nodes&#10;&#10;- The “Assign Target” node is mostly useful for the supervised learning algorithms, where  target values are assigned to specific markers present in the EEG signal. In order for this node to operate correctly you need to know the label for the markers in the data.&#10;&#10;- The “Select Range” node is used to specify certain parts of the data stream. For example, if we have a headset that contains certain bad channels, you can manually remove them here. That is the case for our example here where only data from the last 6 channels are used.&#10;&#10;- The “FIR Filter” node is used to remove the unwanted signals components outside of the EEG signal frequencies, e.g. to keep the 6-30 Hz frequency window.&#10;&#10;- The “Segmentation” node performs the epoching process, where the streamed data is divided into segments of the predefined window-length around the markers on the EEG data.&#10;&#10;NOTE regarding &quot;Segmentation&quot; node:&#10;The epoching process can be either done relative to the marker or the time window. When Processing a large file you should set the epoching relative to markers and while processing the streaming data, you should set it to sliding which chooses a single window at the end of the data.&#10;&#10;Feature extraction:&#10;&#10;Includes: Common Spatial Patterns (CSP) node&#10;As discussed above the spectral and spatial patterns in the data can be extracted by the CSP filters and its extensions.&#10;&#10;Classification:&#10;Includes: Variance, Logarithm, Logistic Regression and Measure Loss&#10;&#10;- The “Logistic Regression” node is used to perform the classification, where supervised learning methods is used to train the classifier. in this node you can choose the type of regularization and the regularization coefficient. You can also set the number of the folds for cross-validation in this node.&#10;&#10;- The “Measure Loss” node is used to measure various performance criteria. Here we use misclassification rate (MCR)." title="Simple Motor Imagery Prediction with CSP" version="2.0">
	<nodes>
		<node id="0" name="Assign Target Values" position="(453.0, 204.0)" project_name="NeuroPype" qualified_name="widgets.machine_learning.owassigntargets.OWAssignTargets" title="Assign Targets" uuid="599045ed-b139-4d0d-b13c-4286e8e80935" version="1.0.1" />
		<node id="1" name="Segmentation" position="(756.0, 275.0)" project_name="NeuroPype" qualified_name="widgets.formatting.owsegmentation.OWSegmentation" title="Segmentation" uuid="1e9e6240-9e86-4920-a89b-affa480622bd" version="1.0.2" />
		<node id="2" name="LSL Output" position="(1369.0, 383.0)" project_name="NeuroPype" qualified_name="widgets.network.owlsloutput.OWLSLOutput" title="LSL Output" uuid="93cbe4cf-0afc-4089-bedd-8a8085bc025a" version="1.4.2" />
		<node id="3" name="Variance" position="(959.0, 346.0)" project_name="NeuroPype" qualified_name="widgets.statistics.owvariance.OWVariance" title="Variance" uuid="c818ff94-3283-40ba-accd-960ccc02efa6" version="1.0.0" />
		<node id="4" name="Logarithm" position="(1064.0, 346.0)" project_name="NeuroPype" qualified_name="widgets.elementwise_math.owlogarithm.OWLogarithm" title="Logarithm" uuid="bc6cbb0b-1ea1-4882-8323-2c91039e1494" version="1.0.0" />
		<node id="5" name="Select Range" position="(553.0, 204.0)" project_name="NeuroPype" qualified_name="widgets.tensor_math.owselectrange.OWSelectRange" title="Select Range" uuid="70b8fb6c-e9f5-4604-9d94-8bb2dc1ef340" version="1.1.0" />
		<node id="6" name="Logistic Regression" position="(1174.0, 346.0)" project_name="NeuroPype" qualified_name="widgets.machine_learning.owlogisticregression.OWLogisticRegression" title="Logistic Regression" uuid="69c062db-3389-4124-8e5f-39d6617be10c" version="1.1.0" />
		<node id="7" name="FIR Filter" position="(654.0, 275.0)" project_name="NeuroPype" qualified_name="widgets.signal_processing.owfirfilter.OWFIRFilter" title="FIR Filter" uuid="0300b024-03db-4159-86ca-d8dd5c5cb929" version="1.1.0" />
		<node id="8" name="LSL Input" position="(137.0, 204.0)" project_name="NeuroPype" qualified_name="widgets.network.owlslinput.OWLSLInput" title="LSL Input" uuid="79b7c641-caf5-49df-ae74-f8c1151a1f1f" version="1.5.1" />
		<node id="9" name="Dejitter Timestamps" position="(243.0, 204.0)" project_name="NeuroPype" qualified_name="widgets.utilities.owdejittertimestamps.OWDejitterTimestamps" title="Dejitter Timestamps" uuid="89c9f895-2e85-4a9c-83f6-f33136640205" version="1.0.0" />
		<node id="10" name="Streaming Bar Plot" position="(1366.0, 280.0)" project_name="NeuroPype" qualified_name="widgets.visualization.owbarplot.OWBarPlot" title="Streaming Bar Plot" uuid="37f7b394-4241-4f8b-bcff-8e5d7bad645a" version="1.0.3" />
		<node id="11" name="Accumulate Calibration Data" position="(348.0, 204.0)" project_name="NeuroPype" qualified_name="widgets.machine_learning.owaccumulatecalibrationdata.OWAccumulateCalibrationData" title="Accumulate Calibration Data" uuid="d9b44353-204f-48cc-92b3-727d16da7c3e" version="1.0.0" />
		<node id="12" name="Source Power Comodulation" position="(859.0, 346.0)" project_name="NeuroPype" qualified_name="widgets.neural.owsourcepowercomodulation.OWSourcePowerComodulation" title="Source Power Comodulation" uuid="2413e752-90a0-496a-878b-0f56a313c029" version="1.0.0" />
		<node id="13" name="Override Axis" position="(1270.0, 280.0)" project_name="NeuroPype" qualified_name="widgets.neural.owoverrideaxis.OWOverrideAxis" title="Override Axis" uuid="38b0929f-b343-4397-abc5-c86a96c2ef9c" version="1.4.2" />
	</nodes>
	<links>
...
DgAAAHNldF9icmVha3BvaW50cRKJWAsAAAB0aW1lX2JvdW5kc3ETXXEUKEc/4AAAAAAAAEdAFgAA
...
UUJ5dGVBcnJheXEKQ0IB2dDLAAMAAAAAAwsAAAGIAAAEdAAAAmEAAAMMAAABpwAABHMAAAJgAAAA
...
LlF0Q29yZXEJWAoAAABRQnl0ZUFycmF5cQpDQgHZ0MsAAwAAAAADCwAAAYMAAAR0AAACiQAAAwwA
...
cRFYDAAAAFB5UXQ1LlF0Q29yZXESWAoAAABRQnl0ZUFycmF5cRNDQgHZ0MsAAwAAAAACjgAAAccA
AAP1AAADCgAAAo4AAAHHAAAD9QAAAwoAAAAAAAAAAAeAAAACjgAAAccAAAP1AAADCnEUhXEVh3EW
...
eXBlCnEPWAwAAABQeVF0NS5RdENvcmVxEFgKAAAAUUJ5dGVBcnJheXERQ0IB2dDLAAMAAAAAAwsA
AAF2AAAEdAAAAtAAAAMMAAABlQAABHMAAALPAAAAAAAAAAAHgAAAAwwAAAGVAAAEcwAAAs9xEoVx
...
IksAdS4=
    ...
    "nodes": {
        "node1": {
            ...
            "uuid": "599045ed-b139-4d0d-b13c-4286e8e80935"
        },
        "node10": {
            ...
            "uuid": "89c9f895-2e85-4a9c-83f6-f33136640205"
        },
        "node11": {
            "class": "BarPlot",
            ...
            "uuid": "37f7b394-4241-4f8b-bcff-8e5d7bad645a"
        },
        "node12": {
            ...
            "uuid": "d9b44353-204f-48cc-92b3-727d16da7c3e"
        },
        "node13": {
            ...
            "uuid": "2413e752-90a0-496a-878b-0f56a313c029"
        },
        "node14": {
            "class": "OverrideAxis",
            ...
            "uuid": "38b0929f-b343-4397-abc5-c86a96c2ef9c"
        },
        "node2": {
            "class": "Segmentation",
            ...
            "uuid": "1e9e6240-9e86-4920-a89b-affa480622bd"
        },
        "node3": {
            "class": "LSLOutput",
            ...
            "uuid": "93cbe4cf-0afc-4089-bedd-8a8085bc025a"
        },
        "node4": {
            "class": "Variance",
            ...
            "uuid": "c818ff94-3283-40ba-accd-960ccc02efa6"
        },
        "node5": {
            "class": "Logarithm",
            ...
            "uuid": "bc6cbb0b-1ea1-4882-8323-2c91039e1494"
        },
        "node6": {
            "class": "SelectRange",
            ...
            "uuid": "70b8fb6c-e9f5-4604-9d94-8bb2dc1ef340"
        },
        "node7": {
            ...
            "uuid": "69c062db-3389-4124-8e5f-39d6617be10c"
        },
        "node8": {
            "class": "FIRFilter",
            ...
            "uuid": "0300b024-03db-4159-86ca-d8dd5c5cb929"
        },
        "node9": {
            "class": "LSLInput",
            ...
            "uuid": "79b7c641-caf5-49df-ae74-f8c1151a1f1f"
        }
    },
    "version": 1.1
}</patch>
